...
if(isset($_POST['submit']))
{
	...
	{
		$sql ="UPDATE student SET studentname='".$_POST['studentname']."',rollno='".$_POST['rollno']."',`dateofbirth`='".$_POST['dateofbirth']."',`schoolid`='".$_POST['schoolid']."',`password`='".$_POST['password']."',`studentclass`='".$_POST['studentclass']."',`section`='".$_POST['section']."',`studentaddress`='".$_POST['studentaddress']."',
		`contactnumber`='".$_POST['contactnumber']."',status='".$_POST['status']."' $condition WHERE studentid='".$_GET['editid']."'";
	...
	{
		$sql ="INSERT INTO student SET studentname='".$_POST['studentname']."',rollno='".$_POST['rollno']."',`dateofbirth`='".$_POST['dateofbirth']."',`schoolid`='".$_POST['schoolid']."',`password`='".$_POST['password']."',`studentclass`='".$_POST['studentclass']."',`section`='".$_POST['section']."',`studentaddress`='".$_POST['studentaddress']."',
		`contactnumber`='".$_POST['contactnumber']."',status='".$_POST['status']."' $condition  ";
		$qsql = mysqli_query($con,$sql);
		if(mysqli_affected_rows($con) ==1)
		{
	...
	<select name="schoolid" id="schoolid" class="form-control">
		<?php
			...
			while($rstudent = mysqli_fetch_array($qsqlstudent))
			{
				...
				{
					if($_SESSION['schoolid'] == $rstudent['schoolid'])
					{
