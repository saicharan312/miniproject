...
<table id="myTable"  class="table table-striped table-bordered" >
	...
	while($rs = mysqli_fetch_array($qsql))
	{
		...
		echo "<tr>
				...
				<td>$rs[status]</td>
				<td><a href='student.php?editid=$rs[0]' class='btn btn-info' style='width: 75px;'>Edit</a>  <a href='viewstudent.php?delid=$rs[0]' onclick='return validatedel()'  class='btn btn-danger' style='width: 75px;' >Delete</a></td>
			</tr>";
	}
	?>
	</tbody>
