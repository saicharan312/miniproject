...
{
	$sql = "SELECT * FROM fooddepartmentofficer WHERE officercode='$_POST[loginid]' AND password='$_POST[loginpassword]' AND status='Active'";
	$qsql = mysqli_query($con,$sql);
	if(mysqli_num_rows($qsql) == 1)
	{
		$rs = mysqli_fetch_array($qsql);
		$_SESSION['officerid']  = $rs['officerid'];
		echo "<script>window.location='fooddepartmentdashboard.php';</script>";
	}
	else
	{
...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg"><b>FOOD DEPARTMENT LOGIN WINDOW</b></p>
