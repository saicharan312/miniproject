...
if(isset($_POST['submit']))
{
	...
	{
		$sql ="UPDATE `state` SET `state`='".$_POST['statename']."',`anynote`='".$_POST['description']."',`status`='".$_POST['status']."' WHERE stateid='".$_GET['editid']."'";
	...
	{  
		$sql ="INSERT INTO state SET `state`='".$_POST['statename']."',`anynote`='".$_POST['description']."',`status`='".$_POST['status']."' ";
		$qsql = mysqli_query($con,$sql);
		if(mysqli_affected_rows($con) ==1)
		{
...
<div class="row">
	...
	<div class="col-md-5">
		<input type="text" class="form-control" name="statename" id="statename" value="<?php if(isset($rsedit['state'])) { echo $rsedit['state']; } ?>"  />
	</div>
	<div class="col-md-4"><span class="errmsg flash" id="errstatename" style="color: red;"></span></div>
</div>
<br>
<div class="row">
...
function confirmvalidation()
{
	...
	{
		document.getElementById("errstatename").innerHTML="State name should not be empty";
		i=1;
	}
