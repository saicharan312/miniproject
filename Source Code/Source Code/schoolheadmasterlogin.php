...
{
	$sql = "SELECT * FROM schoolheadmaster WHERE headmastercode='$_POST[loginid]' AND password='$_POST[loginpassword]' AND status='Active'";
	$qsql = mysqli_query($con,$sql);
	if(mysqli_num_rows($qsql) == 1)
	{
		$rs = mysqli_fetch_array($qsql);
		$_SESSION['schoolheadmasterid']  = $rs['schoolheadmasterid'];
		$_SESSION['schoolid']  = $rs['schoolid'];
...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg"><b>SCHOOL HEAD MASTER LOGIN WINDOW</b></p>
