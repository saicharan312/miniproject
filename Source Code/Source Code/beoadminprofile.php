...
{
	$sql ="UPDATE `beoadmin` SET `adminname`='".$_POST['adminname']."',`loginid`='".$_POST['loginid']."' WHERE beoadminid='$_SESSION[beoadminid]'";
...
{
	$sqledit = "SELECT * FROM beoadmin where beoadminid='$_SESSION[beoadminid]'";
