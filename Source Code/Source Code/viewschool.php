...
<form method="post" action="">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">View School Details</h3>
        </div>
        <div class="card-body">
<table id="myTable"  class="table table-striped table-bordered" >
	...
	while($rs = mysqli_fetch_array($qsql))
	{
		...
		<td>$rs[city]</td>
				<td>$rs[pincode]</td>
				<td>$rs[status]</td>
				<td><a href='school.php?editid=$rs[0]' class='btn btn-info'>Edit</a> | <a href='viewschool.php?delid=$rs[0]' onclick='return validatedel()'  class='btn btn-danger' >Delete</a></td>
			</tr>";
	}
	?>
	</tbody>
