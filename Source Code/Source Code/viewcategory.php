...
<table id="myTable"  class="table table-striped table-bordered" >
	...
	while($rs = mysqli_fetch_array($qsql))
	{
		echo "<tr>
				...
				<td style='width: 350px;'>$rs[categorydetail]</td>
				<td style='width: 70px;'>$rs[status]</td>
				<td style='width: 150px;'><a href='category.php?editid=$rs[0]' class='btn btn-info'>Edit</a> | <a href='viewcategory.php?delid=$rs[0]' onclick='return validatedel()'  class='btn btn-danger' >Delete</a></td>
			</tr>";
	}
	?>
	</tbody>
